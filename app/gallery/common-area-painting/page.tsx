...
export const metadata: Metadata = {
  ...
  description: "View our Common Area Painting Gallery project photos across Mumbai, Thane & Bhiwandi.",
}

const images = [
  { src: "/images/building/service-common-area.jpg", alt: "Common Area Painting" },
  { src: "/images/building/service-staircase-painting.jpg", alt: "Staircase" },
    ...
    <main>
      ...
      <section className="py-16" style={{ backgroundColor: "#1B2B8A" }}>
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-black text-white sm:text-3xl">Need Common Area Painting?</h2>
          <p className="mt-3 text-blue-200 text-sm">Get a free site visit and written quotation today.</p>
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
            <a href="https://wa.me/919158800517?text=Hi%2C%20I%20need%20a%20quote%20for%20Common%20Area%20Painting." target="_blank" rel="noopener noreferrer"
