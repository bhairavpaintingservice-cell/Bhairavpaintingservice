...
export const metadata: Metadata = {
  alternates: { canonical: '/gallery/designer-texture' },
  title: "Designer & Texture Painting Gallery | Bhairav Painting Service",
  description: "View our Designer & Texture Painting project photos across Mumbai, Thane & Bhiwandi. 47+ years experience, premium paint brands, owner supervised.",
}
    ...
    <main>
      <section className="pt-32 pb-12" style={{backgroundColor:"#1B2B8A"}}>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <p className="mt-2 text-blue-200 text-sm">Photos from our designer & texture painting projects across Mumbai, Thane & Bhiwandi.</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            {images.map((img, i) => (
              <div key={i} className="overflow-hidden rounded-xl shadow-sm">
                <div className="relative h-64">
                  <Image src={img} alt={`Designer & Texture Painting project ${i + 1}`} fill className="object-cover hover:scale-105 transition-transform duration-300" sizes="(max-width: 639px) 100vw, (max-width: 1023px) 50vw, 33vw" />
                </div>
              </div>
            ))}
          </div>
          <div className="mt-10 rounded-xl bg-white border border-gray-200 p-6 text-center">
            ...
            <Link href="/services/designer/texture" className="mt-2 inline-block text-sm font-semibold" style={{color:"#1B2B8A"}}>View Designer & Texture Painting Service Details →</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16" style={{backgroundColor:"#1B2B8A"}}>
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-black text-white">Need Designer & Texture Painting?</h2>
          <p className="mt-3 text-blue-200 text-sm">Get a free site visit and written quotation today.</p>
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
            <a href="https://wa.me/919158800517?text=Hi%2C%20I%20need%20a%20quote%20for%20Designer%20&%20Texture%20Painting." target="_blank" rel="noopener noreferrer"
