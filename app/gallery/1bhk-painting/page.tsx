...
export const metadata: Metadata = {
  ...
  description: "Photos from our 1BHK flat painting projects across Mumbai, Thane & Bhiwandi.",
}

const images = [
  { src: "/images/residential/res-1bhk.jpg", alt: "1BHK Flat Painting" },
  { src: "/images/residential/res-before-after-1.jpg", alt: "1BHK Before After" },
  { src: "/images/residential/res-before-after-3.jpg", alt: "1BHK Before After 2" },
]
    ...
    <main>
      <section className="pt-32 pb-12" style={{ backgroundColor: "#1B2B8A" }}>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <p className="mt-2 text-blue-200 text-sm">Photos from our 1BHK flat painting projects across Mumbai, Thane & Bhiwandi.</p>
        </div>
      </section>
      ...
      <section className="py-16" style={{ backgroundColor: "#1B2B8A" }}>
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-black text-white sm:text-3xl">Want 1BHK Painting for Your Flat?</h2>
          <p className="mt-3 text-blue-200 text-sm">Get a free site visit and written quotation today.</p>
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
            <a href="https://wa.me/919158800517?text=Hi%2C%20I%20need%20a%20quote%20for%201%20BHK%20Painting." target="_blank" rel="noopener noreferrer"
