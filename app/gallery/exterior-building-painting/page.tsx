...
export const metadata: Metadata = {
  ...
  description: "View our Exterior Building Painting Gallery project photos across Mumbai, Thane & Bhiwandi.",
}

const images = [
  { src: "/images/building/service-exterior-building.jpg", alt: "Exterior Building Painting" },
  { src: "/images/exterior/house.jpg", alt: "Exterior House" },
  { src: "/images/building/service-society-repainting.jpg", alt: "Society Exterior" },
]
    ...
    <main>
      <section className="pt-32 pb-12" style={{ backgroundColor: "#1B2B8A" }}>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <p className="mt-2 text-blue-200 text-sm">Photos from our projects across Mumbai, Thane & Bhiwandi.</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-10 rounded-xl bg-white border border-gray-200 p-6 text-center">
            ...
            <div className="mt-4">
              <Link href="/services/building" className="text-sm font-semibold" style={{ color: "#1B2B8A" }}>View Building Service Details →</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16" style={{ backgroundColor: "#1B2B8A" }}>
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-black text-white sm:text-3xl">Need Exterior Building Painting?</h2>
          <p className="mt-3 text-blue-200 text-sm">Get a free site visit and written quotation today.</p>
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
            <a href="https://wa.me/919158800517?text=Hi%2C%20I%20need%20a%20quote%20for%20Exterior%20Building%20Painting." target="_blank" rel="noopener noreferrer"
