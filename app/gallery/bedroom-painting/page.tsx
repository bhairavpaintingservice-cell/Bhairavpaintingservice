...
export const metadata: Metadata = {
  alternates: { canonical: '/gallery/bedroom-painting' },
  title: "Bedroom Painting Gallery | Bhairav Painting Service",
  description: "View our Bedroom Painting project photos across Mumbai, Thane & Bhiwandi.",
}
    ...
    <main>
      <section className="pt-32 pb-12" style={{backgroundColor:"#1B2B8A"}}>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <h1 className="mt-4 text-3xl font-black text-white sm:text-4xl">Bedroom Painting Gallery</h1>
          <p className="mt-2 text-blue-200 text-sm">Photos from our bedroom painting projects across Mumbai, Thane & Bhiwandi.</p>
        </div>
      </section>
            ...
            {images.map((img, i) => (
              <div key={i} className="overflow-hidden rounded-xl shadow-sm">
                <div className="relative h-64">
                  <Image src={img} alt={`Bedroom Painting ${i+1}`} fill className="object-cover hover:scale-105 transition-transform duration-300" sizes="(max-width: 639px) 100vw, (max-width: 1023px) 50vw, 33vw" />
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16" style={{backgroundColor:"#1B2B8A"}}>
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-black text-white">Need Bedroom Painting?</h2>
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
            <a href="https://wa.me/919158800517?text=Hi%2C%20I%20need%20Bedroom%20Painting." target="_blank" rel="noopener noreferrer"
