...
export const metadata: Metadata = {
  alternates: { canonical: '/gallery/society-exterior-painting' },
  title: "Society Exterior Painting Gallery | Bhairav Painting Service",
  description: "View our Society Exterior Painting Gallery project photos across Mumbai, Thane & Bhiwandi.",
}

const images = [
  { src: "/images/exterior/society.jpg", alt: "Society Painting" },
  { src: "/images/exterior/ba-2.jpg", alt: "Society Before After" },
  { src: "/images/exterior/ba-6.jpg", alt: "Multi-Building Society" },
]
    ...
    <main>
      <section className="pt-32 pb-12" style={{ backgroundColor: "#1B2B8A" }}>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <h1 className="mt-4 text-3xl font-black text-white sm:text-4xl">Society Exterior Painting Gallery</h1>
      ...
      <section className="py-16" style={{ backgroundColor: "#1B2B8A" }}>
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-black text-white sm:text-3xl">Need Society Exterior Painting?</h2>
          <p className="mt-3 text-blue-200 text-sm">Get a free site visit and written quotation today.</p>
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
            <a href="https://wa.me/919158800517?text=Hi%2C%20I%20need%20a%20quote%20for%20Society%20Exterior%20Painting." target="_blank" rel="noopener noreferrer"
