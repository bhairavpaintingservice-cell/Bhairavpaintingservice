...
export const metadata: Metadata = {
  ...
  description: "View our Waterproofing Gallery project photos across Mumbai, Thane & Bhiwandi.",
}

const images = [
  { src: "/images/building/service-waterproofing.jpg", alt: "Waterproofing" },
    ...
    <main>
      ...
      <section className="py-16" style={{ backgroundColor: "#1B2B8A" }}>
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-black text-white sm:text-3xl">Need Waterproofing?</h2>
