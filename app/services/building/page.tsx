...
export default function BuildingPaintingPage() {
  ...
  const handleSubmit = () => {
    ...
    if (typeof window !== "undefined") {
      ...
      ;(window as any).dataLayer.push({ event: "generate_lead", form_name: "building_service_page", service: form.service, area: form.area, page_path: window.location.pathname })
    }
          ...
          <div className="mt-10">
            ...
            <div className="space-y-3 max-w-3xl">
              {[
                ...
                { q: "Do you offer pre-monsoon society or building painting?", a: "Yes, pre-monsoon society painting and building painting is one of our most requested services. We use rain-proof paint for housing societies and boundary walls, and offer monsoon building protection to prevent damage before the rains arrive." },
                { q: "Are you building painting contractors in Bhiwandi?", a: "Yes, we are experienced building painting contractors based in Bhiwandi, serving societies and outdoor building painting projects across Bhiwandi, Thane, Kalyan and Navi Mumbai." },
                { q: "Do you provide building painting in Dombivli, Thane and Kalyan too?", a: "Yes, building painting services extend to Dombivli, Thane and Kalyan along with Bhiwandi, covering both new construction and repainting projects." },
                { q: "Are you society painting contractors for housing complexes?", a: "Yes, we work as society painting contractors in Kalyan and Thane, and also handle housing complex and housing society exterior painting projects in Navi Mumbai and Mumbai." },
                { q: "Do you handle building renovation and repair painting?", a: "Yes, our building renovation painters handle repair painting in Bhiwandi and Mumbai, including building protection coating and full exterior painting services." },
                { q: "Do you provide scaffolding-based building and boundary wall painting?", a: "Yes, building painting with scaffolding is standard for high-rise and multi-storey work, and we cover boundary wall painting in both Thane and Mumbai." },
              ].map((faq, i) => (
              ...
              <div key={i} className="group rounded-xl overflow-hidden border border-gray-100 bg-white shadow-sm hover:shadow-md transition">
                <div style={{display:"grid", gridTemplateColumns:"1fr 1fr"}}>
                  <div style={{position:"relative", height:"160px"}}>
                    <Image src={p.before} alt={`Before building painting - ${p.title} Mumbai Thane Bhiwandi`} fill className="object-cover" sizes="(max-width: 639px) 100vw, (max-width: 1023px) 50vw, 33vw"/>
                  ...
                  <div style={{position:"relative", height:"160px"}}>
                    <Image src={p.after} alt={`After building painting - ${p.title} by Bhairav Painting Service Mumbai Thane Bhiwandi`} fill className="object-cover group-hover:scale-105 transition-transform duration-300" sizes="(max-width: 639px) 100vw, (max-width: 1023px) 50vw, 33vw"/>
          ...
          <div className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-4">
            {relatedServices.map((s, i) => (
              <Link key={i} href={s.href} className="overflow-hidden rounded-xl bg-white border-2 border-gray-100 hover:border-orange-400 transition-colors text-center">
                <div className="relative h-24 group overflow-hidden">
                  <Image src={s.image} alt={`${s.title} in Mumbai Thane Bhiwandi - Bhairav Painting Service`} fill className="object-cover" sizes="(max-width: 639px) 100vw, (max-width: 1023px) 50vw, 33vw"/>
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                    <a href="/gallery/building" className="bg-white text-xs font-bold px-3 py-1.5 rounded-full" style={{color:"#1B2B8A"}}>View More →</a>
                  </div>
                </div>
