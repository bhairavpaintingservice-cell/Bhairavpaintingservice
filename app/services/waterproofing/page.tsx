...
const faqs = [
  ...
  { q: "Kya aap Bhiwandi aur Thane mein professional painting contractors provide karte hain?", a: "Haan, professional painters aur house painters Bhiwandi aur Thane dono jagah available hain. Local repainting services ke liye pre-monsoon painting contractors bhi book kar sakte hain." },
  { q: "Rain-proof coating aur primer kaunse options available hain?", a: "Hum rain-proof aur rain-resistant wall coating, building coating aur primer application provide karte hain — walls, buildings aur railings sabke liye weatherproof painting solutions available hain." },
...
const projects = [
  { before: "/images/waterproofing/p1-before.jpg", after: "/images/waterproofing/p1-after.jpg", title: "Terrace Waterproofing", scope: "450 sq ft • Dr Fixit Membrane • 3 Days", problem: "Terrace leakage during monsoon — water dripping into flat below.", solution: "Dr Fixit liquid membrane waterproofing + crack filling.", gallery: "/gallery/terrace-waterproofing" },
  { before: "/images/waterproofing/p2-before.jpg", after: "/images/waterproofing/p2-after.jpg", title: "Roof Leakage Repair", scope: "280 sq ft • Liquid Membrane • 2 Days", problem: "Ceiling stains and water dripping from roof during rain.", solution: "Roof crack repair + Pidilite liquid membrane application.", gallery: "/gallery/roof-leakage-repair" },
  { before: "/images/waterproofing/p3-before.jpg", after: "/images/waterproofing/p3-after.jpg", title: "Bathroom Waterproofing", scope: "80 sq ft • Dr Fixit Pidifin 2K • 1 Day", problem: "Bathroom floor seepage causing damp ceiling in flat below.", solution: "Dr Fixit Pidifin 2K waterproofing on floor and walls.", gallery: "/gallery/bathroom-waterproofing" },
  { before: "/images/waterproofing/p4-before.jpg", after: "/images/waterproofing/p4-after.jpg", title: "Damp Wall Treatment", scope: "3 Rooms • Anti-damp Coating • 2 Days", problem: "Paint peeling and damp patches on interior walls due to moisture.", solution: "Anti-damp primer + waterproof putty + anti-fungal paint.", gallery: "/gallery/damp-wall-treatment" },
  { before: "/images/waterproofing/p5-before.jpg", after: "/images/waterproofing/p5-after.jpg", title: "Exterior Waterproofing", gallery: "/gallery/exterior-waterproofing", scope: "Building Exterior • Weather Coat • 4 Days", problem: "Exterior wall cracks allowing water seepage during monsoon.", solution: "Crack filling + Berger WeatherCoat exterior waterproofing." },
  { before: "/images/waterproofing/p6-before.jpg", after: "/images/waterproofing/p6-after.jpg", title: "Basement Waterproofing", gallery: "/gallery/basement-waterproofing", scope: "Basement • Crystalline Coating • 3 Days", problem: "Basement walls wet due to high water table and rain seepage.", solution: "Crystalline waterproofing compound + injection grouting." },
