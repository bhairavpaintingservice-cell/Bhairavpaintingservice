...
const faqs = [
  ...
  { q: "Do you provide residential painting services in Bhiwandi, Navi Mumbai, Vasai and Kasheli?", a: "Yes, we are a residential painting service company covering Bhiwandi, Navi Mumbai, Vasai, Kasheli and surrounding areas. Whether it's an apartment, flat or independent house, our team of home painters handles the complete job with a free site visit first." },
  { q: "Do you offer pre-monsoon and rain-resistant home painting?", a: "Yes. Pre-monsoon home painting is one of our most requested services — we use rain-resistant, monsoon-proof exterior paint that protects walls from seepage and damage during heavy rain. Booking before monsoon season is recommended for the best results." },
  { q: "Do you have experience with apartment painting projects?", a: "Yes, our team includes apartment painting experts experienced with 1BHK, 2BHK, 3BHK flats and larger residential complexes across Mumbai and Thane region." },
